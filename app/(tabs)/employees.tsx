      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        {activeTab === 'pending' ? (
          pendingUsers.map((employee, index) => (
            <View key={employee.id ? `pending-${employee.id}` : `pending-index-${index}`} style={styles.card}>
          ...
          <View key={employee.id ? `employee-${employee.id}` : `employee-index-${index}`} style={styles.card}>
            <View style={styles.cardHeader}>
              <View style={styles.avatar}>
